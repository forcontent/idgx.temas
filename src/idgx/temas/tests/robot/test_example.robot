...
#
#  $ bin/test -s idgx.temas -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src idgx.temas.testing.IDGX_TEMAS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/idgx/temas/tests/robot/test_example.robot
#
